...
public enum CourseCode implements ResponseCode {
    ...
    TRANSFER_COURSE_FAIL_COURSE_NOT_FOUND(false, 50004, "教师转让课程失败，未找到该课程！"),

    TRANSFER_COURSE_FAIL_PASSWORD_WRONG(false, 50005, "教师转让课程失败，请求转入教师的密码错误！"),

    TRANSFER_COURSE_FAIL_EMAIL_NOT_EFFECTIVE(false, 50006, "教师转让课程失败，接受转入课程的教师邮箱无效！"),

    TRANSFER_COURSE_FAIL_COURSE_NOT_BELONGS_TO_THIS_TEACHER(false, 50007, "教师转让课程失败，该教师不是此课程原授课教师！"),

    TRANSFER_COURSE_FAIL_SAME_TEACHER(false, 50008, "教师转让课程失败，原授课教师不能转让给自己！"),

    UPDATE_COURSE_FAIL_COURSE_NOT_FOUND(false, 50009, "更新课程信息失败，未找到该课程！"),
    ...
    STUDENT_COURSE_NOT_FOUND(false, 50000, "学生-课程记录不存在！");
