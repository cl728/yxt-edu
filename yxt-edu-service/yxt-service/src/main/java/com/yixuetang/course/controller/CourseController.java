...
public class CourseController implements CourseControllerApi {
    ...
    @Override
    @GetMapping("studentCourse/courseId/{courseId}")
    public QueryResponse findStudentCourseList(@PathVariable long courseId) {
        return courseService.findStudentCourseList( courseId );
    }

    @Override
    @PutMapping("studentCourse/usualScore")
